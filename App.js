...
import {View, Text, TextInput, TouchableOpacity, Scrolllview} from 'react-native'; 
import './global.css'
...
const App = () => {
  ...
  const agregarTarea = () => {
    ...
    if (nuevaTarea.trim()==='') return //Si no se escribe nada se sale de la funcion 
    ...
    setTareas([...tareas, tarea]) //Haciendo una copia de las tares anteriores mas la nueva
    setNuevaTarea('') //Se resetea para evitar la sobreescritura
  }
